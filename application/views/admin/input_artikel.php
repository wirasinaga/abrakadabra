...
<?php echo form_open_multipart('kd_admin/proses_tambah_artikel') ?>
...
<div class="tab-pane active" id="biodata">
    <table class="table table-bordered">
        <tr class="success"><th colspan="2">INPUT DATA ARTIKEL</th></tr>
  
        <tr>
          <td>Judul Artikel</td>
          <td>
              <div class="col-md-4">
              <input type='text' name='judul' placeholder='JUDUL BLOG' class='form-control'  value='' >
              </div>
            </td>
        </tr>
         <tr>
        ...
        <tr>
        <td>Isi Blog</td>
          <td><textarea name="artikel" id="news"></textarea>
