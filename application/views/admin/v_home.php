  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a style="font-family: courier" class="logo"><b>CPANEL ABRAKADABRA BATIK</b></a>
            <!--logo end-->
            <div class="nav notify-row" id="top_menu">
                ...
                <ul class="nav top-menu">
                    <!-- settings start -->
                    <li class="dropdown">
                        <a data-toggle="" class="dropdown-toggle" href="index.php/ci_admin/konfirmasi">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center" style="color:black;font-family: courier">
             copyright &copy; 2019 Cpanel Admin Abrakadabra Batik
              <a href="index.php/ci_admin/#" class="go-top">
