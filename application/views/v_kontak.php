	 ...
	 <div id="contact-page" class="container">
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
				    	...
				    	<?php echo form_open('kategori/insert_kontak'); ?>
				    	<div id="main-contact-form" class="contact-form row" name="contact-form" method="post" >
				            ...
				            <div class="form-group col-md-12">
				                <textarea name="pesan" id="message" required="required" class="form-control" rows="8" placeholder="Your Message Here"></textarea>
				            </div>                        
				            <div class="form-group col-md-12">
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>Ar-Rhoudoh : Jl. Sumantri Brojonegoro No.50-54 Simpang Pulai, Kota Jambi. Jambi Telp (0741) 64398</p>

<p>Istana Jambi Berkah : Jl. Sumantri Brojonegoro No.83 Simpang Pulai, Kota Jambi. Jambi Telp (0741) 668622</p>
<p>
Gallery Abrakadabra Batik: Jl. Husni Thamrin No. 83 Simpang Mangga, Kota Jambi, Jambi Telp (0741) 22732
