...
class Login_admin extends ci_controller{
	...
	public function index(){
        ...
        $this->form_validation->set_rules('password_admin', 'password_admin', 'trim|required|xss_clean|callback_check_database');// disini terdapat callback : callback_check_database. digunakan untuk memanggil function check_database() dibawah.

        		if($this->form_validation->run() == FALSE){
        			redirect('ci_admin/log_in/?gagal=1','refresh');
        		}else{
	...
	public function check_database(){
        ...
        $this->load->model('model_admin');                 
		$result=$this->model_admin->admin($nama_admin,$password_admin);
